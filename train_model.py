...
if __name__ == '__main__':
    ...
    print(sys.argv)
    #4.2013.33R##########
    sys.argv.append('D:/brain/i-care-international-cardiac-arrest-research-consortium-database-1.0/training')
    sys.argv.append('D:/brain/i-care-international-cardiac-arrest-research-consortium-database-1.0/model')
    #####################
